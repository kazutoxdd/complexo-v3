SUGGESTIONS = {
	...
	{
		name = "/pm",
		help = "Chat de conversa da policia militar."
	},
	{
		name = "/pc",
		help = "Chat de conversa da policia civil."
	},
	{
		name = "/penal",
		help = "Chat de conversa da policia penal."
	},
	{
		name = "/915",
		help = "Chat de comunicação para PCD's em ações da policia."
	},
	{
		name = "/me",
