...
local List = {
	...
	{ -- Chiliad (Routes)
		Distance = 10,
		Coords = { 2185.22,5575.73,53.9,274.97 },
		Model = "g_m_y_ballaorig_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Families (Routes)
		Distance = 10,
		Coords = { -164.94,-1608.36,33.68,249.45 },
		Model = "g_m_y_ballaorig_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Highways (Routes)
	...
	{ -- Vagos (Routes)
		Distance = 10,
		Coords = { 327.78,-1988.74,24.2,229.61 },
		Model = "g_m_y_ballaorig_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Vagos (Routes)
	...
	{ -- Barragem (Routes)
		Distance = 10,
		Coords = { 1437.16,-213.28,191.35,170.08 },
		Model = "g_m_y_ballaorig_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Farol (Routes)
	...
	{ -- Praia-1 (Routes)
		Distance = 10,
		Coords = { -3204.52,1400.87,16.73,79.38 },
		Model = "g_m_y_ballaorig_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Praia-2 (Routes)
