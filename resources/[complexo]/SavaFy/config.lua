...
cfg.zones = {
	{
		...
		coords = vector3(-1376.88, -607.75, 31.32), -- the position where the music is played
		...
		changemusicblip = vector3(-1378.49, -628.87, 30.63) -- where the player can change the music
	},
	{
		name = "Vanilla", -- The name of the radio, it doesn't matter
