...
local animacoes = {
	...
	["bujao"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "cpx_bujao", flag = 50, mao = 28422 },
	["pride"] = { dict = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = "prideflag", flag = 50, mao = 28422 },
	["pride2"] = { dict = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = "prideflag2", flag = 50, mao = 28422 },
	["pride3"] = { dict = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = "prideflag3", flag = 50, mao = 28422 },
	["pride4"] = { dict = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = "prideflag4", flag = 50, mao = 28422 },
	["pride5"] = { dict = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = "prideflag5", flag = 50, mao = 28422 },
	["pride6"] = { dict = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = "prideflag1", flag = 50, mao = 28422 },
	["pride7"] = { dict = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = "prideflag9", flag = 50, mao = 28422 },
	["pride8"] = { dict = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = "prideflag10", flag = 50, mao = 28422 },
	["pride9"] = { dict = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = "prideflag11", flag = 50, mao = 28422 },
	["pride10"] = { dict = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = "prideflag12", flag = 50, mao = 28422 },
	["jacarepereira"] = { dict = "rcmnigel1d", anim = "base_club_shoulder", prop = "prideflag7", flag = 51, mao = 18905, altura = 0.08, pos1 = -0.2090, pos2 = 0.0900, pos3 = -82.6677, pos4 = -141.2988, pos5 = 12.3308 },
	...
	["biblia"] = { dict = "cellphone@", anim = "cellphone_text_read_base", prop = "cpx_biblia", flag = 50, mao = 28422 },
	...
	["alianca"] = { dict = "amb@code_human_wander_eating_donut_fat@female@base", anim = "static", prop = "mah_alianca", flag = 50, mao = 28422 },
	...
	["forapaulo"] = { dict = "rcmnigel1d", anim = "base_club_shoulder", prop = "forapaulo", flag = 51, mao = 18905, altura = 0.08, pos1 = -0.2090, pos2 = 0.0900, pos3 = -82.6677, pos4 = -141.2988, pos5 = 12.3308 },

	["pauloplinio"] = { dict = "rcmnigel1d", anim = "base_club_shoulder", prop = "prideflag6", flag = 51, mao = 18905, altura = 0.08, pos1 = -0.2090, pos2 = 0.0900, pos3 = -82.6677, pos4 = -141.2988, pos5 = 12.3308 },
...
-- DANCAS
	["cpx1"] = { dict = "custom@crossbounce", anim = "crossbounce", andar = false, loop = true },
	["cpx2"] = { dict = "custom@dont_start", anim = "dont_start", andar = false, loop = true },
	["cpx3"] = { dict = "custom@floss", anim = "floss", andar = false, loop = true },
	["cpx4"] = { dict = "custom@orangejustice", anim = "orangejustice", andar = false, loop = true },
	["cpx5"] = { dict = "custom@renegade", anim = "renegade", andar = false, loop = true },
	["cpx6"] = { dict = "custom@rickroll", anim = "rickroll", andar = false, loop = true },
	["cpx7"] = { dict = "custom@savage", anim = "savage", andar = false, loop = true },
	["cpx8"] = { dict = "custom@sayso", anim = "sayso", andar = false, loop = true },
	["cpx9"] = { dict = "custom@take_l", anim = "take_l", andar = false, loop = true },
	["cpx10"] = { dict = "custom@toosie_slide", anim = "toosie_slide", andar = false, loop = true },
	["cpx11"] = { dict = "mj_thriller", anim = "mj_thriller_dance", andar = false, loop = true },
	["cpx12"] = { dict = "dancing_wave_part_one@anim", anim = "wave_dance_1", andar = false, loop = true },
	["cpx13"] = { dict = "dancing_wave_part_one@anim", anim = "wave_dance_2", andar = false, loop = true },
	["cpx14"] = { dict = "dancing_wave_part_one@anim", anim = "wave_dance_3", andar = false, loop = true },
	["cpx15"] = { dict = "dancing_wave_part_one@anim", anim = "wave_dance_4", andar = false, loop = true },
	["cpx16"] = { dict = "dancing_wave_part_one@anim", anim = "tutankhamun_dance_1", andar = false, loop = true },
	["cpx17"] = { dict = "dancing_wave_part_one@anim", anim = "tutankhamun_dance_2", andar = false, loop = true },
	["cpx18"] = { dict = "dancing_wave_part_one@anim", anim = "snake_dance_1", andar = false, loop = true },	
	["cpx19"] = { dict = "dancing_wave_part_one@anim", anim = "slide_dance", andar = false, loop = true },
	["cpx20"] = { dict = "dancing_wave_part_one@anim", anim = "slide_dance_2", andar = false, loop = true },
	["cpx21"] = { dict = "dancing_wave_part_one@anim", anim = "robot_dance", andar = false, loop = true },
	["cpx22"] = { dict = "dancing_wave_part_one@anim", anim = "locking_dance", andar = false, loop = true },
	["cpx23"] = { dict = "dancing_wave_part_one@anim", anim = "headspin", andar = false, loop = true },
	["cpx24"] = { dict = "dancing_wave_part_one@anim", anim = "flaire_dance", andar = false, loop = true },
	["cpx25"] = { dict = "dancing_wave_part_one@anim", anim = "crowd_girl_dance", andar = false, loop = true },
	["cpx26"] = { dict = "dancing_wave_part_one@anim", anim = "uprock_dance_1", andar = false, loop = true },
	["cpx27"] = { dict = "dancing_wave_part_two@anim", anim = "1990", andar = false, loop = true },
	["cpx28"] = { dict = "dancing_wave_part_two@anim", anim = "footwork_01", andar = false, loop = true },
	["cpx29"] = { dict = "dancing_wave_part_two@anim", anim = "headspin", andar = false, loop = true },	
	["cpx30"] = { dict = "dancing_wave_part_two@anim", anim = "moonwalk", andar = false, loop = true },	
	["cpx31"] = { dict = "dancing_wave_part_two@anim", anim = "n_move", andar = false, loop = true },	
	["cpx32"] = { dict = "dancing_wave_part_two@anim", anim = "sdan", andar = false, loop = true },
	["cpx33"] = { dict = "dancing_wave_part_two@anim", anim = "ball_01", andar = false, loop = true },
	["cpx34"] = { dict = "dancing_wave_part_two@anim", anim = "pose1", andar = false, loop = true },
	["cpx35"] = { dict = "dancing_wave_part_two@anim", anim = "pose2", andar = false, loop = true },
	["cpx36"] = { dict = "dancing_wave_part_two@anim", anim = "kp", andar = false, loop = true },
	["cpx37"] = { dict = "dancing_wave_part_two@anim", anim = "robo", andar = false, loop = true },
	["cpx38"] = { dict = "dancing_wave_part_two@anim", anim = "dance_s001", andar = false, loop = true },
	["cpx39"] = { dict = "dancing_wave_part_two@anim", anim = "street", andar = false, loop = true },
	["cpx40"] = { dict = "dancing_wave_part_two@anim", anim = "street_2", andar = false, loop = true },	
-- FACIAIS
	["face1"] = { dict = "switch@trevor@under_pier", anim = "exit_ped_facial", andar = false, loop = true },
	["face2"] = { dict = "switch@trevor@pushes_bodybuilder", anim = "001426_03_trvs_5_pushes_bodybuilder_exit_bb1_facial", andar = false, loop = true },
	["face3"] = { dict = "switch@trevor@escorted_out", anim = "001215_02_trvs_12_escorted_out_exit_guard2_facial", andar = false, loop = true },
	["face4"] = { dict = "switch@trevor@block_camera", anim = "001220_03_gc_trvs_ig_7_exit_generic_facial", andar = false, loop = true },
	["face5"] = { dict = "switch@michael@tray_exits_car", anim = "001840_01_mics3_ig_21_tracy_exits_car_tra_facial", andar = false, loop = true },
	["face6"] = { dict = "switch@michael@around_the_table_selfish", anim = "around_the_table_selfish_jimmy_facial", andar = false, loop = true },
	["face7"] = { dict = "missexile2", anim = "take_down_bad_guy_facial", andar = false, loop = true },
	["face8"] = { dict = "misschop_vehicle@back_of_van", anim = "chop_bark_facial", andar = false, loop = true },
	["face9"] = { dict = "facials@p_m_zero@variations@excited", anim = "mood_excited_1", andar = false, loop = true },
	["face10"] = { dict = "facials@mime@variations@normal", anim = "mood_normal_1", andar = false, loop = true },
	["face11"] = { dict = "facials@gestures@", anim = "mood_normal", andar = false, loop = true },
	["face12"] = { dict = "facials@gen_female@base", anim = "blowkiss_1", andar = false, loop = true },
	["face13"] = { dict = "facials@gen_female@base", anim = "electrocuted_1", andar = false, loop = true },
	["face14"] = { dict = "facials@gen_female@base", anim = "mood_sleeping_1", andar = false, loop = true },
	["face15"] = { dict = "anim@mp_player_intcelebrationmale@surrender", anim = "surrender_facial", andar = false, loop = true },
	["face16"] = { dict = "anim@mp_player_intcelebrationmale@shush", anim = "shush_facial", andar = false, loop = true },
	["face17"] = { dict = "anim@mp_player_intcelebrationmale@photography", anim = "photography_facial", andar = false, loop = true },
	["face18"] = { dict = "anim@mp_player_intcelebrationmale@finger_kiss", anim = "finger_kiss_facial", andar = false, loop = true },
	["face19"] = { dict = "anim@mp_player_intcelebrationmale@call_me", anim = "call_me_facial", andar = false, loop = true },
	["face20"] = { dict = "anim@mp_player_intcelebrationfemale@smoke_flick", anim = "smoke_flick_facial", andar = false, loop = true },
	["face21"] = { dict = "anim@mp_player_intcelebrationfemale@slow_clap", anim = "slow_clap_facial", andar = false, loop = true },
-- NOVAS ANIMAÇÕES
	...
	["picole2"] = { dict = "amb@code_human_wander_drinking@beer@male@base", anim = "static", prop = "cpx_picolebkn2", flag = 49, mao = 28422 },
	["picole3"] = { dict = "amb@code_human_wander_drinking@beer@male@base", anim = "static", prop = "cpx_picolebkn3", flag = 49, mao = 28422 },
	["picole4"] = { dict = "amb@code_human_wander_drinking@beer@male@base", anim = "static", prop = "cpx_picolebkn4", flag = 49, mao = 28422 },
	["picole5"] = { dict = "amb@code_human_wander_drinking@beer@male@base", anim = "static", prop = "cpx_picolebkn5", flag = 49, mao = 28422 },
	["ovo"] = { dict = "impexp_int-0", anim = "mp_m_waremech_01_dual-0", prop = "cpx_easter2", flag = 49, mao = 60309 },
	["cesta"] = { prop = "cpx_easter", flag = 50, mao = 57005, altura = 0.16, pos1 = 0, pos2 = 0, pos3 = 0, pos4 = 260.0, pos5 = 60.0 },
	["maca"] = { dict = "amb@code_human_wander_eating_donut@female@idle_a", anim = "idle_c", prop = "cpx_maca", flag = 49, mao = 28422 },
	...
	-- NOVAS --
	["pose45"] = { dict = "sunsetpose9@animation", anim = "sunsetpose9_clip", andar = false, loop = true },
	["pose46"] = { dict = "sunsetpose10@animation", anim = "sunsetpose10_clip", andar = false, loop = true },
	["pose47"] = { dict = "sunsetpose11@animation", anim = "sunsetpose11_clip", andar = false, loop = true },
	["pose48"] = { dict = "lunyx@rgmp01", anim = "rgmp01", andar = false, loop = true },
	["pose49"] = { dict = "lunyx@rgmp02", anim = "rgmp02", andar = false, loop = true },
	["pose50"] = { dict = "lunyx@rgmp03", anim = "rgmp03", andar = false, loop = true },
	["pose51"] = { dict = "lunyx@rgmp04", anim = "rgmp04", andar = false, loop = true },
	["pose52"] = { dict = "lunyx@rgmp05", anim = "rgmp05", andar = false, loop = true },
	["pose53"] = { dict = "lunyx@rgmp06", anim = "rgmp06", andar = false, loop = true },
	["pose54"] = { dict = "lunyx@rgmp07", anim = "rgmp07", andar = false, loop = true },
	["pose55"] = { dict = "lunyx@attention@001", anim = "attention@001", andar = false, loop = true },
	["pose56"] = { dict = "lunyx@attention@002", anim = "attention@002", andar = false, loop = true },
	["pose57"] = { dict = "lunyx@attention@003", anim = "attention@003", andar = false, loop = true },
	["pose58"] = { dict = "lunyx@attention@004", anim = "attention@004", andar = false, loop = true },
	["pose59"] = { dict = "lunyx@attention@005", anim = "attention@005", andar = false, loop = true },
	["pose60"] = { dict = "ceeflexing@animation", anim = "ceeflexing_clip", andar = false, loop = true },
	["pose61"] = { dict = "ceemoneystack@animation", anim = "ceemoneystack_clip", andar = false, loop = true },	
	["pose62"] = { dict = "ceejaaybo@animation", anim = "ceejaaybo_clip", andar = false, loop = true },	
	["pose63"] = { dict = "ceelightingup@animation", anim = "ceelightingup_clip", andar = false, loop = true },
	["pose64"] = { dict = "ceekilla1@animation", anim = "ceekilla1_clip", andar = false, loop = true },	
	["pose65"] = { dict = "lunyx@eta@p1", anim = "eta@p1", andar = false, loop = true },
	["pose66"] = { dict = "lunyx@eta@p2", anim = "eta@p2", andar = false, loop = true },
	["pose67"] = { dict = "lunyx@eta@p3", anim = "eta@p3", andar = false, loop = true },
	["pose68"] = { dict = "lunyx@eta@p4", anim = "eta@p4", andar = false, loop = true },
	["pose69"] = { dict = "lunyx@eta@p5", anim = "eta@p5", andar = false, loop = true },	
	["pose70"] = { dict = "lunyx@iambeauty@p1", anim = "iambeauty@p1", andar = false, loop = true },	
	["pose71"] = { dict = "lunyx@iambeauty@p2", anim = "iambeauty@p2", andar = false, loop = true },	
	["pose72"] = { dict = "lunyx@iambeauty@p3", anim = "iambeauty@p3", andar = false, loop = true },
	["pose73"] = { dict = "lunyx@iambeauty@p4", anim = "iambeauty@p4", andar = false, loop = true },
	["pose74"] = { dict = "lunyx@iambeauty@p5", anim = "iambeauty@p5", andar = false, loop = true },	
	["pose75"] = { dict = "lunyx@iambeauty@p6", anim = "iambeauty@p6", andar = false, loop = true },
	["pose76"] = { dict = "lunyx@iambeauty@p7", anim = "iambeauty@p7", andar = false, loop = true },
	["pose77"] = { dict = "lunyx@iambeauty@p8", anim = "iambeauty@p8", andar = false, loop = true },	
	["pose78"] = { dict = "lunyx@iambeauty@p9", anim = "iambeauty@p9", andar = false, loop = true },													
	-- NOVAS
	...
	["foto130"] = {  dict= "anim@cargirl_look_back" , anim = "look_back_clip" , andar = false , loop = true },
	["foto131"] = {  dict= "anim@cargirl_peace" , anim = "peace_clip" , andar = false , loop = true },
	["foto132"] = {  dict= "anim@lbp_kneeling_point" , anim = "kneeling_point_clip" , andar = false , loop = true },
	["foto133"] = {  dict= "anim@model_flipoff_cute" , anim = "flipoff_cute_clip" , andar = false , loop = true },
	["foto134"] = {  dict= "anim@model_kylie_insta" , anim = "kylie_insta_clip" , andar = false , loop = true },
	["foto135"] = {  dict= "anim@selfie_instagram_booty" , anim = "instagram_booty_clip" , andar = false , loop = true },
	["foto136"] = {  dict= "lunyx@boygroup@p1" , anim = "boygroup@p1" , andar = false , loop = true },
	["foto137"] = {  dict= "lunyx@boygroup@p2" , anim = "boygroup@p2" , andar = false , loop = true },
	["foto138"] = {  dict= "lunyx@boygroup@p3" , anim = "boygroup@p3" , andar = false , loop = true },
	["foto139"] = {  dict= "lunyx@boygroup@p4" , anim = "boygroup@p4" , andar = false , loop = true },
	["foto140"] = {  dict= "lunyx@boygroup@p5" , anim = "boygroup@p5" , andar = false , loop = true },
	["foto141"] = {  dict= "lunyx@boygroup@p6" , anim = "boygroup@p6" , andar = false , loop = true },
	["foto142"] = {  dict= "lunyx@boygroup@p7" , anim = "boygroup@p7" , andar = false , loop = true },
	["foto143"] = {  dict= "lunyx@minipack@v1@pose001" , anim = "minipack@v1@pose001" , andar = false , loop = true },
	["foto144"] = {  dict= "lunyx@minipack@v1@pose002" , anim = "minipack@v1@pose002" , andar = false , loop = true },
	["foto145"] = {  dict= "lunyx@minipack@v1@pose003" , anim = "minipack@v1@pose003" , andar = false , loop = true },
	["foto146"] = {  dict= "lunyx@minipack@v1@pose004" , anim = "minipack@v1@pose004" , andar = false , loop = true },
	["foto147"] = {  dict= "lunyx@minipack@v1@pose005" , anim = "minipack@v1@pose005" , andar = false , loop = true },
