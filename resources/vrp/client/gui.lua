...
-- Contraband North
LocalPlayer["state"]:set("GasStation",false,false)
LocalPlayer["state"]:set("Hookies",false,false)
LocalPlayer["state"]:set("RoadKill",false,false)
LocalPlayer["state"]:set("Union",false,false)
LocalPlayer["state"]:set("Fishing",false,false)
LocalPlayer["state"]:set("Resort",false,false)
LocalPlayer["state"]:set("YellowJack",false,false)
LocalPlayer["state"]:set("Blarneys",false,false)
LocalPlayer["state"]:set("Training",false,false)
-- Favelas Global
LocalPlayer["state"]:set("Barragem",false,false)
LocalPlayer["state"]:set("Barragem2",false,false)
LocalPlayer["state"]:set("Barragem3",false,false)
...
LocalPlayer["state"]:set("Michael",false,true)
...
LocalPlayer["state"]:set("FuriousRecords",false,false)
LocalPlayer["state"]:set("Bahamas",false,false)
LocalPlayer["state"]:set("Nashi",false,false)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local Walk = nil
