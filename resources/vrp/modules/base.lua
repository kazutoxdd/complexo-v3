...
function vRP.CharacterChosen(source,Passport,Model)
    ...
    if not Characters[source] then
        ...
        if #Query > 0 then
            ...
            Characters[source]["serial"] = Query[1]["serial"]
            ...
            Characters[source]["spotify"] = Account["spotify"]
        ...
        TriggerEvent("discordLogs","Entrou", "**Source:**"..source.. [[**Passaporte:**]]..Passport.. [[**Nome:**]]..name.. [[**Ip:**]]..GetPlayerEndpoint(source),3092790)
