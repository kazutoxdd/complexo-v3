...
vRP.Prepare("characters/setSerial","UPDATE characters SET serial = @serial WHERE id = @Passport")
...
vRP.Prepare("accounts/setSpotify","UPDATE accounts SET spotify = @spotify WHERE license = @license")
...
vRP.Prepare("accounts/updateSpotify","UPDATE accounts SET spotify = spotify + 2592000 WHERE license = @license")
...
vRP.Prepare("painel/SetSpotify","UPDATE organizations SET spotify = @Seconds WHERE name = @Name")
-----------------------------------------------------------------------------------------------------------------------------------------
-- FINES
-----------------------------------------------------------------------------------------------------------------------------------------
